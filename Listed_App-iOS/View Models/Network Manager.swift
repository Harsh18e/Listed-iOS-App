...
class NetworkManager {
    ...
    func apiCall(_ urlString: String, completion: @escaping (Result<Data, NetworkError>) -> Void) {
        ...
        urlRequest.addValue("Bearer \(Constants.BEARER_TOKEN)", forHTTPHeaderField: "Authorization")
